...
from tkinter import GROOVE, WORD
...
def main_screen():
    ...
    screen=Tk()
    screen.geometry('370x398')
    #icon
    try:
        image_icon = Image.open("F:\\UoM\\Python Projects\\Secret Message Generator\\keys.png")
    ...
    Button(text="DECRPT",height="2",width="23",bg="#00bd56",fg="white",bd=0,command=decrypt).place(x=200,y=250)
